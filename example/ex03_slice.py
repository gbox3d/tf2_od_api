...
# %%
# load image
image_path = '../test_img/IMG_4191.jpg'
print('load image')

src_image = Image.open(image_path)
display(src_image.rotate(-90))

cropx = 1024
cropy = 1024
crop_img = src_image.crop([cropx,cropy,cropx+512,cropy+512]).rotate(-90)

# numpy형으로 변환
image_np = np.array(crop_img)
...
# 추정치가 50% 이상만 추출
_detections = [v for v in zip(scores, classes, boxes) if v[0] > 0.2]
